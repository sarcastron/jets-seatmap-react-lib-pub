...
const rightArrow = '<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="114.000000pt" height="114.000000pt" viewBox="0 0 114.000000 114.000000" preserveAspectRatio="xMidYMid meet"><g transform="translate(0.000000,114.000000) scale(0.100000,-0.100000)" fill="#d00434" stroke="none"><path d="M290 950 l0 -129 -95 54 -95 54 0 -354 0 -354 95 54 95 54 0 -129 0 -129 344 252 c334 245 343 252 322 268 -11 9 -166 122 -343 252 l-323 236 0 -129z"/></g></svg>'
...
export const JetsDeckExit = ({ type, index, topOffset }) => {
  ...
  return (
    <div className="deck-exit" style={style}>
      ...
      {type === 'left' ? (
        <span className="deck-exit__image" dangerouslySetInnerHTML={{
          __html: leftArrow,
        }}></span>
      ) : (
        <span className="deck-exit__image" dangerouslySetInnerHTML={{
